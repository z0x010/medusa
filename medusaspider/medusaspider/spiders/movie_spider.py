...
class MovieSpider(scrapy.spiders.Spider):
    ...
    def parse(self, response):
        ...
        a callback method:
            extract some items,
            looks for a link to follow to the next page,
            and then yields a Request with the same callback for it;
        """
        # print response
        ...
        # [1][extract links from the page, follow them, and then extract data from the pages]
        print '++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++'
